...
class MyNuevoCoche(Gtk.Window):
    def __init__(self):
        ...
        self.entry1.set_text("Matricula")
        self.label1 = Gtk.Label("Matricula", xalign=0)
        ...
        self.entry2.set_text("Marca")
        self.label2 = Gtk.Label("Marca", xalign=0)
        ...
        self.entry3.set_text("Km")
        self.label3 = Gtk.Label("Km", xalign=0)
    ...
    def on_boton_aceptar_clicked(self, button):
        ...
        if len(self.entry1.get_text()) > 0 and len(self.entry2.get_text()) > 0:
            bd.InsertCoche.MyCoche().crearCoche(self.entry1.get_text(),
